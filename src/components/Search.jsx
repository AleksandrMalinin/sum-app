        ...
        <div className='flex flex-col gap-1 max-h-60 overflow-y-auto'>
          {allArticles.map((item, index) => (
            ...
            >
              ...
              <p className='flex-1 font-satoshi text-blue-700 font-light text-sm truncate'>
                {item.url}
              </p>
            </div>
          ))}
        ...
        {isFetching ? (
          ...
          article.summary && (
            <div className='flex flex-col gap-3'>
              <h2 className='summary-title font-satoshi font-bold text-gray-600 text-xl'>
                Summary
              </h2>
              <div className='summary-content'>
                <p className='font-inter font-light text-sm text-gray-700'>
                  {article.summary}
                </p>
              </div>
            </div>
